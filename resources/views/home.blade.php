                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="box box-block bg-white tile tile-1 m-b-2">
                            ...
                            <div class="t-content">
                                ...
                                <h1 class="m-b-1">30</h1>
                                <span class="tag tag-danger m-r-0-5">Jumlah Keseluruhan</span>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="box box-block bg-white tile tile-1 m-b-2">
                            ...
                            <div class="t-content">
                                ...
                                <i class="fa fa-caret-up text-success m-r-0-5"></i><span>Periode 2022</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="box box-block bg-white tile tile-1 m-b-2">
                            ...
                            <div class="t-content">
                                ...
                                <h1 class="m-b-1">2</h1>
                                <span class="tag tag-primary m-r-0-5">Periode 2022</span>
                                <span class="text-muted font-90"></span>
                            </div>
                        </div>
                    </div>

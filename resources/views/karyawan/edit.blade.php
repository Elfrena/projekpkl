            ...
            @foreach ($data as $it)
                <form action="{{url('updatekry',$it->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <input type="text" name="nip" id="nip" class="form-control" value="{{$it->nip}}" readonly>
                        </div>
                    </div>
                    {{-- <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <input type="text" name="tmp_lahir" id="tmptlahir" class="form-control" value="{{$it->tempat_lahir}}" placeholder="Tempat Lahir ..." required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <input type="tel" name="tlpn" id="notlpn" class="form-control" value="{{$it->telpon}}" placeholder="08XXXXXXXXXX ..." required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="email" class="col-xs-2 col-form-label text-capitalize">E-mail</label>
                        <div class="col-xs-10">
                            <input type="email" name="email" id="email" class="form-control" value="{{$it->email}}" placeholder="kantor@gmail.com ..." required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <select class="custom-select" name="jabatan" id="jabatan">
                                <option selected>{{ $it->jabatan }}</option>
                    ...
                    <div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="photo" type="file" class="form-control" name="filename">
                            </div>
                        </div>
                    </div>
                    {{-- <div class="form-group row">
